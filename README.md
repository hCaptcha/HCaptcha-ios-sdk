...
Notes:
 - Carthage doesn't support prebuilts for `xcframework` - https://github.com/Carthage/Carthage/issues/3130
 - `RxSwift` build issue - https://github.com/Carthage/Carthage/issues/3243
