        ...
        <html>
          <head>
            ...
            <script type="text/javascript">
              ...
              var buildSetDataPayload = function(params) {
                var data = {};

                if (params.phonePrefix !== undefined) {
                  data.mfa_phoneprefix = params.phonePrefix;
                }
                if (params.phoneNumber !== undefined) {
                  data.mfa_phone = params.phoneNumber;
                }
                if (params.rqdata !== undefined) {
                  data.rqdata = params.rqdata;
                } else if ("${rqdata}" !== "") {
                  data.rqdata = "${rqdata}";
                }
                if (params.userJourney !== undefined) {
                  data.userJourney = params.userJourney;
                }
              ...
              var setVerifyParams = function(params) {
                ...
                try {
                  var data = buildSetDataPayload(params || {});
                  if (data && window.hCaptchaID) {
